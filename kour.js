    ...
    */
    watermark() {
        ...
        function animate() {
            ...
            // (kourInstance.config.InstantKill) {
            //  lines.push("<c>✔ In")
            //else {
            //  lines.push("<c>✖ In")
            //}
